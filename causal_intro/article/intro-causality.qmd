...
```{r load data}
df <- targets::tar_read(simulate, store = here("_targets"))
coefs <- targets::tar_read(coefs, store = here("_targets"))
...
# plot both figures
dag_grob <- image_read_pdf(here("article/figures/model_open_data_citations.pdf")) %>% 
  as.grob()
...
# plot both figures
dag_grob <- image_read_pdf(here("article/figures/model_open_data_on_reproducibility.pdf")) %>% 
  as.grob() 
