...
The [OpenAIRE Graph](https://graph.openaire.eu) does not yet have OA colors (Green OA, Gold OA, etc.) as part of its dump yet, but it is expected before the end of PathOS.
