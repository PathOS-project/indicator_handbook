...
The metric is to provide the overview of the[]{#_Int_0uJu4pci} sum of
capital investments policy making bodies on the
international/national/regional levels into related Research
Infrastructures. The investment can be of CAPEX (capital expenditure) or
OPEX (operational expenses) qualities and is to describe the financial
commitment of governing bodies in executing related OS policies. The
limitation of the metric derives from the complexity on what to include
as financial investment in OS infrastructure, therefore the related
national formuli can be varied which makes the comparison somewhat
problematic as there is no consensus what a distinguished OS-related
investment means therefore what R&I investments to consider when
calculating the investent levels. Currently there are ongoing
