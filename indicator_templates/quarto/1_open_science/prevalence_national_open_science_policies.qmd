...
|         |               |                             |               |
|         |               |                             |               |
|         | 2023-06-30    | Minor edits                 | L. Stoy (TGB) |
| 0.2     | 2023-02-28    | Extended content            | L. Stoy (TGB) |
| 0.1     | 2023-02-14    | Initial version of document | L. Stoy (TGB) |

## Description

This indicator aims to capture the existence of country-level policies for open science. Since Open Science can be considered a catch-all term for different practices and objectives, as elaborated in the UNESCO Recommendation on Open Science, this may include different elements or distinct policies such as open access to publications, open data, fair data, research assessment reform, citizen science etc. A
...
Description automatically generated with medium confidence](figures/9c7413cea25d4ac6b909a77c37a945a00b3d4301.png)

Source: Gareth O'Neill. (2022). Monitoring Framework for National Contributions to EOSC (Version V1). Zenodo. <https://doi.org/10.5281/zenodo.7410762> (Licensed using [Creative Commons Attribution 4.0 International](https://creativecommons.org/licenses/by/4.0/legalcode))
