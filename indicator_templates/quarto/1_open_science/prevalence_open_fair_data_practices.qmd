...
Might be relevant also for indicator on data usage, not only for indicator on data sharing.
...
Determining the level of FAIR data practices can involve assessing how well data adheres to the FAIR principles at each stage of the data lifecycle, from creation to sharing and reuse.
