...
# Open Data Citation Advantage {#open-data-citation-advantage .unnumbered}

We here provide some idea of what it would take to try to infer the causal effect of one specific Open Science practice on citation impact. In particular, we consider the effect of Open Data on citation impact. That is, papers that share their data might be more likely to be cited. This is something that has been called the "Open Data Citation Advantage", and in the PathOS scoping review of the academic impact of Open Science (<https://osf.io/preprints/socarxiv/ptjub>), evidence was found for a small positive effect of sharing data.
...
![](figures/21a09dd0e47d782dbdce32697ea333869cf996b9.jpg)[Miro board](https://miro.com/app/board/uXjVLFAZ5EM=/?share_link_id=863741786128)
