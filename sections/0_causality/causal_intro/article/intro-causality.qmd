---
title: "Causality in science studies"
author: 
  - name: Thomas Klebel
...
```{r set up themes for plotting, echo=FALSE}
...
df <- targets::tar_read(simulate, store = here("sections/0_causality/causal_intro/_targets"))
coefs <- targets::tar_read(coefs, store = here("sections/0_causality/causal_intro/_targets"))
...
# plot both figures
dag_grob <- image_read_pdf(here("sections/0_causality/causal_intro/article/figures/model_open_data_citations.pdf")) %>%
  as.grob()
...
# plot both figures
dag_grob <- image_read_pdf(here("sections/0_causality/causal_intro/article/figures/model_open_data_on_reproducibility.pdf")) %>%
  as.grob() 
