...
To measure the proposed metric, the tool can be used to identify relevant publications that have introduced or (re)used datasets and calculate their NCI score.
